...
<body>
  ...
  <div class="listMainBox">
    <div class="typewriter">
      This is the list of all trainers
    </div>
      ...
      <tbody>
                <c:forEach items="${listOfTrainers}" var = "trainers">
                    <tr>
                        ...
                        <td class="actions">
                            <a href="${pageContext.request.contextPath}/trainer/update/${trainers.idTrainer}">
                                <img src="resources/assets/img/edit.png"></a>
                            <a href="${pageContext.request.contextPath}/trainer/delete?id=${trainers.idTrainer}">
                                <img src="resources/assets/img/delete.png"></a>
                        </td>
                    </tr>
                </c:forEach>
      </tbody>
    ...
    <div id="outer">
      <div class="inner"><a class="button1" href="${pageContext.request.contextPath}/trainer/create">Create Trainer</a></div>
      <div class="inner"><a class="backButton" href="${pageContext.request.contextPath}">Back</a></div>
