...
<html lang="en">
    ...
    <body>
        ...
        <div class="listMainBox">
            ...
            <c:if test="${editTrainer == null}">
                <c:url value="/trainer/create" var="link"></c:url>
            </c:if>

            <c:if test="${editTrainer != null}">
                <c:url value="/trainer/update" var="link"></c:url>
            </c:if>
            <form:form action="${link}" method="POST" modelAttribute="editTrainer" cssClass="container listMainBox">
                <input hidden readonly type="number" name="idTrainer" value="${editTrainer.idTrainer}"class="con2"/><br>
                <input type="text" name="firstName" value="${editTrainer.firstName}" placeholder="First name" class="con1"><br>
                <form:errors path="firstName"/>
                <input type="text" name="lastName" value="${editTrainer.lastName}" placeholder="Last name" class="con1"><br>
                <form:errors path="lastName"/>
                <input type="text" name="subject" value="${editTrainer.subject}" placeholder="Subject" class="con1"><br>
                <div class="inner"><input type="submit" value="Enter" class="button1"/></div>
                <div class="inner"><a class="backButton" href="${pageContext.request.contextPath}/trainer">Back</a></div>
            </form:form>
